...
| <a name="input_cpu_proc_type"></a> [cpu\_proc\_type](#input\_cpu\_proc\_type) | CPU processor type | `string` | `"shared"` | no |
...
| <a name="input_memory_size"></a> [memory\_size](#input\_memory\_size) | Memory size | `string` | `"64"` | no |
...
| <a name="input_number_of_processors"></a> [number\_of\_processors](#input\_number\_of\_processors) | Number of CPU processor type | `string` | `"1"` | no |
...
| <a name="input_powervs_instance_name"></a> [powervs\_instance\_name](#input\_powervs\_instance\_name) | PowerVS instance name | `string` | `"quickstart"` | no |
...
| <a name="input_powervs_os_image_name"></a> [powervs\_os\_image\_name](#input\_powervs\_os\_image\_name) | Image to be deployed | `string` | `"RHEL8-SP4-SAP-NETWEAVER"` | no |
...
| <a name="input_server_type"></a> [server\_type](#input\_server\_type) | Server type | `string` | `"s922"` | no |
...
| <a name="input_storage_config"></a> [storage\_config](#input\_storage\_config) | Storage configuration for the instance | <pre>object({<br>    names      = string<br>    disks_size = string<br>    counts     = string<br>    tiers      = string<br>    paths      = string<br>  })</pre> | <pre>{<br>  "counts": "2",<br>  "disks_size": "2000,2000",<br>  "names": "data",<br>  "paths": "/data",<br>  "tiers": "tier3"<br>}</pre> | no |
